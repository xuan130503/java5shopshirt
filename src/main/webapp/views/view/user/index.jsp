         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <span class="toggle_icon" onclick="openNav()"><img src="<c:url value='/views/templates/user/images/toggle-icon.png'/>"></span>
                  <div class="dropdown">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="<c:url value='/views/templates/user/images/flag-uk.png'/>" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="<c:url value='/views/templates/user/images/flag-france.png'/>" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
                     <div class="login_menu">
						<ul>
		                    <li><a href="/user/cart">Cart</a>
			                	<i class="fa fa-shopping-cart" aria-hidden="true"></i>  
		                    </li>
	                    </ul>       
	                    <div class="dropdown">
		                    <button class="btn btn-secondary" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-user" aria-hidden="true"></i>
		                    </button>
	                     	<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
		                       <c:choose>
	                  			<c:when test="${not empty CurrentUser}">
	                  				<a class="dropdown-item" href="#">Change pass</a>
			                        <a class="dropdown-item" href="/logout">Logout</a>
	                  			</c:when>
	                  			<c:otherwise>
	                  			 	<a class="dropdown-item" href="/trangchu/login">Login</a>
			                        <a class="dropdown-item" href="/registry">Register</a>
	                  			</c:otherwise>
	                  			</c:choose>
	                     	</div>
                  		</div> 	
	...
	<div class="fashion_section">
		<div id="main_slider" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<div class="container">
						<h1 class="fashion_taital">NEW</h1>
									...
									<div class="col-lg-4 col-sm-4">
										<div class="box_main">
											...
											<div class="tshirt_img">
												<img src="<c:url value='/views/templates/user/images/${item.image}'/>">
											</div>
											<div class="btn_main">
												<div class="buy_bt">
													<a href="/user/buy-product/${item.id}">Buy Now</a>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="d-inline-block justify-content-center">
							<a class="btn page-link ${ index==page?'text-warning':'text-secondary' }" href="/trangchu?page=${ index }">
								${ index + 1 }
							</a>
						</div>
						</c:forEach>
	...
	<!-- fashion section end -->
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="location_main">Help Line Number : <a href="#"></a></div>
         </div>
      </div>
      <!-- footer section end -->
